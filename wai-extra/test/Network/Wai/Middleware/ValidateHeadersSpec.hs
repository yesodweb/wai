...
spec = do
    describe "validateHeadersMiddleware" $ do
        ...
        it "does not allow whitespace in header names" $ do
            withHeadersApp [("white space", "foo")] $
                assertStatus 500 =<< request defaultRequest
            withHeadersApp [("white\nspace", "foo")] $
                assertStatus 500 =<< request defaultRequest
            withHeadersApp [("white\rspace", "foo")] $
                assertStatus 500 =<< request defaultRequest
            withHeadersApp [("white\tspace", "foo")] $
                assertStatus 500 =<< request defaultRequest
            withHeadersApp [("ehite\vspace", "foo")] $
                assertStatus 500 =<< request defaultRequest
            withHeadersApp [("white\fspace", "foo")] $
                assertStatus 500 =<< request defaultRequest
        ...
        it "does not allow other whitespace in header values" $ do
            withHeadersApp [("MyHeader", "white\nspace")] $
                assertStatus 500 =<< request defaultRequest
            withHeadersApp [("MyHeader", "white\rspace")] $
                assertStatus 500 =<< request defaultRequest
            withHeadersApp [("MyHeader", "white\vspace")] $
                assertStatus 500 =<< request defaultRequest
            withHeadersApp [("MyHeader", "white\fspace")] $
                assertStatus 500 =<< request defaultRequest

        it "does not allow control characters in header values" $ do
            -- Just examples again
            withHeadersApp [("MyHeader", "control character \0")] $
                assertStatus 500 =<< request defaultRequest
            withHeadersApp [("MyHeader", "control character \27")] $
                assertStatus 500 =<< request defaultRequest

        it "does not allow trailing whitespace in header values" $ do
            withHeadersApp [("MyHeader", " foo")] $
                assertStatus 500 =<< request defaultRequest
            withHeadersApp [("MyHeader", "foo ")] $
                assertStatus 500 =<< request defaultRequest
...
withHeadersApp headers session =
    withSession
        (validateHeadersMiddleware defaultValidateHeadersSettings $ headersApp headers)
        session
